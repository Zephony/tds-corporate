...
class BuyerReport(CommonColumnsMixin, BaseModel):
    __tablename__ = 'buyer_reports'

    _info = {
        'description': 'Buyer reporting data for analytics',
        'type': 'report',
        'api': {
            'routes': [
                'get_all',
    ...
    total_spent: Mapped[Numeric] = mc(Numeric(15, 2), default=0.00, info={
        'name': 'total_spent',
        'display_name': 'Total Spent',
        'description': 'Total amount spent by the buyer',
