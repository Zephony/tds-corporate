...
class CreditPurchasedReport(CommonColumnsMixin, BaseModel):
    __tablename__ = 'credit_purchased_reports'

    _info = {
        'description': 'Credit purchased reporting data showing users with highest credit purchases',
        'type': 'report',
        'api': {
            'routes': [
                'get_all',
    ...
    # Credit metrics (ordered by importance for this report)
    credit_purchased: Mapped[int] = mc(Integer, default=0, info={
        'name': 'credit_purchased',
        'display_name': 'Credit Purchased',
        'description': 'Total number of credits purchased by the user (primary sort field)',
        'display_type': 'number',
        'is_visible': True,
        'is_editable': True,
        'is_required': True,
