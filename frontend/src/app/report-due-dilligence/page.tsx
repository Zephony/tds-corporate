...
export default function ReportDueDilligence() {
    ...
    const [topCreditUsageColumns, setTopCreditUsageColumns] = useState([
        {
            name: 'Signed up on',
            id: 'transaction_date',
            visible: true,
    ...
    // Pass values to the main table
    const [creditPurchasedColumns, setCreditPurchasedColumns] = useState([
        {
            name: 'Transaction On',
            id: 'transaction_date',
            visible: true,
    ...
    // Pass values to the main table
    const [mostVerifiedColumns, setMostVerifiedColumns] = useState([
        {
            name: 'Transaction On',
            id: 'transaction_date',
            visible: true,
    ...
    const [activeTab, setActiveTab] = useState('top_credit_usage')
                    ...
                    <div className='table-wrapper'>
                        ...
                        <div className='table-container'>
                            <Table
                                ...
                                columns={
                                    activeTab === 'top_credit_usage' ? topCreditUsageColumns :
                                    activeTab === 'credit_purchased' ? creditPurchasedColumns :
                                    activeTab === 'most_verified' ? mostVerifiedColumns :
                                    activeTab === 'api_usage' ? topCreditUsageColumns :
                                    activeTab === 'check_type' ? creditPurchasedColumns :
                                    mostVerifiedColumns
                                }
                                controlColumns={[]}
