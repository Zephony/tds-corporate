...
export default function ReportSeller() {
    ...
    const [topSellersColumns, setTopSellersColumns] = useState([
        {
            name: 'Signed up on',
            id: 'transaction_date',
            visible: true,
    ...
    // Pass values to the main table
    const [topRatedColumns, setTopRatedColumns] = useState([
        {
            name: 'Transaction On',
            id: 'transaction_date',
            visible: true,
                    ...
                    <div className='table-wrapper'>
                        ...
                        <div className='table-container'>
                            <Table
                                ...
                                columns={
                                    activeTab === 'top_sellers' ? topSellersColumns :
                                    activeTab === 'top_rated' ? topRatedColumns :
                                    activeTab === 'disputes' ? disputesColumns :
                                    activeTab === 'dispute_breakdown' ? topSellersColumns :
                                    activeTab === 'listing' ? topRatedColumns :
                                    activeTab === 'product_performance' ? disputesColumns :
                                    disputesColumns
                                }
                                controlColumns={[]}
