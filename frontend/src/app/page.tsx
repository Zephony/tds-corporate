...
export default function Dashboard() {
    ...
    // const [chartStartDate, setChartStartDate] = useState(moment().format('YYYY-MM-DD'));
    // useEffect(() => {
    //     // downloadSpreadsheet(chartYears, chartStartDate);
    //     downloadChart(chartYears, chartStartDate);
    // }, [chartYears, chartStartDate]);

    // function downloadSpreadsheet(years, startDate) {
    //     // let url = `scenarios/${id}/spreadsheet?no_of_years=${years || chartYears}&start_date=${startDate || chartStartDate}`;
    ...
    // function downloadChart(years, startDate) {
    //     // let url = `scenarios/${id}/chart?no_of_years=${years || chartYears}&start_date=${startDate || chartStartDate}`;
    //     // request.get(url, (status_, data) => {
    ...
    //         // });
    //         // setChart(newData);
    //         // console.log('__________________________', data.data);
    //         // setChart(data.data);
    //     // });
    // }
    ...
    //         http_status: 200,
    //         data: [
    //             { date: '2025-10-06 10:00', charge_used: 20, charge_remaining: 80 },
    //             { date: '2025-10-06 10:30', charge_used: 40, charge_remaining: 70 },
    //             { date: '2025-10-06 11:00', charge_used: 60, charge_remaining: 60 },

    //         ],
    //         message: null
    //     };

    //     // ✅ Instead of request.get, set the state directly
    //     setChart(mockChartResponse.data);
    // }


    // // useEffect(() => {
    // //     console.log('Requesting spreadsheet..');
    // //     downloadSpreadsheet();
    // // }, [chartStartDate]);
    ...
    // useEffect(() => {
    //     downloadChart(chartYears);
    // }, [])

    // useEffect(() => {
    //     if (chartRef.current && chartRef.current.offsetWidth) {
...
//         return {
//             key: item.date,
//             value: item.charge_used,
//             balance: item.charge_remaining
//         }
//     });
...
//     data.map((item, index) => {
//         let x = (leftPadding + xScale(index)), // - (barWidth / 2),
//             y = (topPadding + y1Scale(item.value));
...
//             <CurvedLine points={points} fill='green' />
//             <CurvedLine points={pointsTwo} fill='red' />
...
//             , '')
//         // console.log(d, 'sd---------------------')
//         return <path d={d} fill="none" stroke={props.fill} strokeWidth={1.5} />
//     }
...
//                 {value != 0 && <line x2={props.width + 20}  />}
